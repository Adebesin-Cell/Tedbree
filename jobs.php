...
<head>
    ...
    <title>Tedbree - Find the best candidates for your organisation.</title>
</head>
<body>
    <header class="header">
        <div class="container">
            <div class="header__wrapper">
                <div class="header__logo-box">
                    <a href="" class="header__logo-link">
                        <img src="assets/svg/find-jobs.svg" alt="find jobs" class="header__logo">
                    </a>
                </div>
                <nav class="navigation">
                    <ul class="navigation__list">
                        <li class="navigation__item">
                            <a href="#" class="navigation__link" name="Jobs">
                                Jobs
                            </a>
                        </li>
                        <li class="navigation__item">
                            <a href="#" class="navigation__link" name="Company Review ">
                                Company Review 
                            </a>
                        </li>
                        <li class="navigation__item">
                            <a href="#" class="navigation__link" name="Find Salaries">
                                Find Salaries
                            </a>
                        </li>
                        <a href="./index.php" class="btn btn--post-job">
                            Post Job
                        </a>
                    </ul>
                </nav>
            ...
            <div class="search">
                <form action="#" class="search__box">
                    <div class="search__group">
                        ...
                        <input type="text" class="search__input" name="job-title" id="input" placeholder="Front end developer">
                    </div>
                    <div class="search__group">
                        <label for="location">
                            <span class="search__icon">
                        ...
                        <input type="text" class="search__input" name="location" id="location" placeholder="Lagos, Nigeria">
                    </div>
    ...
    <section class="section-job-listing">
        <div class="container">
            <div class="listing">
                <div class="listing__details">
                    <p class="listing__estimations">
                        Showing 68 results
                    </p>
                    <div class="listing__filters">
                        <div class="listing__group">
                            ...
                            <input type="text" class="listing__input" id="listing">
                            <span class="listing__icon">
                                <svg width="10" height="7" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 1L5 5.97778L9 1" stroke="#3E3E40" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </span>
                        </div>
                        <ul class="listing__options listing__options--hidden">
                            <li class="options">Latest</li>
                            <li class="options">Oldest</li>
                        </ul>
                    </div>
                </div>
